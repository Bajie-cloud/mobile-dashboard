...
const OperationIcon = ({ active }: { active: boolean }) => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
    <circle
      cx="12"
      cy="12"
...
const MemberIcon = ({ active }: { active: boolean }) => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
    <path
...
const BottomTabBar: React.FC = () => {
  ...
  const tabs = [
    ...
    },
    {
      key: '/operation',
      title: '营运',
      icon: (active: boolean) => <OperationIcon active={active} />,
    },
    {
      key: '/member',
      title: '会员',
    ...
    },
    {
      key: '/menu',
      title: '菜品',
      icon: (active: boolean) => <MenuIcon active={active} />,
    },
  ];

  return (
    <div 
      className="bottom-fixed bg-white"
      style={{ 
