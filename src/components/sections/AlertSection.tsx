    ...
    return [
      {
        ...
        level: "high",
        title: "门店当日总营业额降幅预警",
        description: "上海南京路店当日总营业额环比昨日降幅52%，超过50%预警阈值",
        storeId: "store_001",
        storeName: "上海南京路店",
        region: "华东区",
        currentValue: 7600,
      ...
      },
      {
        ...
        level: "high",
        title: "门店当日堂食客流降幅预警",
        description: "深圳福田中心店当日堂食来客环比昨日降幅55%，超过50%预警阈值",
        storeId: "store_002",
        storeName: "深圳福田中心店",
        region: "华南区",
        currentValue: 280,
      ...
      },
      {
        ...
        level: "high",
        title: "门店当日外卖订单数降幅预警",
        description: "北京王府井店当日外卖订单数环比昨日降幅51%，超过50%预警阈值",
        storeId: "store_003",
        storeName: "北京王府井店",
        region: "华北区",
        currentValue: 145,
      ...
      },
      {
        ...
        level: "medium",
        title: "门店当日外卖实收营业额占比预警",
        description: "广州天河店当日外卖实收营业额占当日总营业比达85%，超过80%预警阈值",
        storeId: "store_004",
        storeName: "广州天河店",
        region: "华南区",
        currentValue: 85.0,
      ...
      },
      {
        ...
        level: "medium",
        title: "门店当日外卖实收营业额占比预警",
        description: "杭州西湖店当日外卖实收营业额占当日总营业比仅3%，在0%-5%预警范围内",
        storeId: "store_005",
        storeName: "杭州西湖店",
        region: "华东区",
        currentValue: 3.0,
              ...
              <List.Item
                ...
                description={
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between items-center">
                      <span className="text-sm text-gray-600">变化幅度</span>
