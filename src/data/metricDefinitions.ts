...
export const metricDefinitions: MetricDefinition[] = [
  ...
  // 渠道分析
  {
    id: 'channel_ratio',
    name: '堂食外卖比',
    definition: '当日堂食和外卖的结构比',
    algorithm: '堂食占比=堂食应收/当日总营业额\n外卖占比=外卖实收/当日总营业额',
    category: '渠道分析'
  },
  {
    id: 'dine_in_traffic',
  ...
  },
  {
    ...
    algorithm: '=当日的外卖总实收营业额/当日的外卖订单数',
    category: '渠道分析'
  },
  ...
  // 门店梯度表现
  {
    id: 'top10_stores',
    name: 'top10门店',
    definition: '当日营业额（堂食应收+外卖实收）排名前10的门店',
    algorithm: '/',
    category: '门店梯度表现'
  },
  {
    id: 'bottom10_stores',
    name: '末位10门店',
    definition: '当日营业额（堂食应收+外卖实收）排名倒数10位的门店',
    algorithm: '/',
    category: '门店梯度表现'
  },
  ...
  },
  {
    ...
    name: '门店当日外卖订单数降幅预警',
    definition: '门店当日外卖订单数环比昨日降幅50%',
    algorithm: '/',
    category: '异常预警'
  },
  {
    id: 'takeout_ratio_high_alert',
    name: '门店当日外卖实收营业额占比预警（高）',
    definition: '门店当日外卖实收营业额占当日总营业比≥80%',
    algorithm: '/',
    category: '异常预警'
  },
  {
    id: 'takeout_ratio_low_alert',
    name: '门店当日外卖实收营业额占比预警（低）',
    definition: '门店当日外卖实收营业额占当日总营业比在0%至5%范围',
    algorithm: '/',
    category: '异常预警'
  }
];
