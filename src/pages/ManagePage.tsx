...
import { NavBar, List, Switch, Button, Toast, Tabs } from 'antd-mobile';
import { useNavigate } from 'react-router-dom';
import { ArrowLeft, ChevronUp, ChevronDown, GripVertical, Palette } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="p-4">
        <Tabs defaultActiveKey="sections">
          <Tabs.Tab title="指标管理" key="sections">
            <div className="mt-4">
              <div className="mb-4 text-sm text-gray-600">
                您可以拖拽 ⋮⋮ 图标或使用上下箭头调整各个指标数据的显示顺序，
                若选择关闭部分指标数据，相应入口将隐藏，但不会清空任何历史数据。
              </div>
